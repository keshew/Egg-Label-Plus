...
extension LoadingView {
    ...
    func req() {
        ...
        conversionData["bundle_id"] = "com.app.egglabelplusegg"
        conversionData["os"] = "iOS"
        conversionData["store_id"] = "6756572525"
        conversionData["locale"] = Locale.current.identifier
        conversionData["firebase_project_id"] = "220978949256"

        do {
            let jsonData = try JSONSerialization.data(withJSONObject: conversionData, options: [])
                    let url = URL(string: "https://egglabelplus.com/config.php")!
